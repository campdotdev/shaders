...
// client boundary: the docs site consumes this file as source, not the built
// dist, so the directive has to live here rather than in a build banner.
// esbuild keeps it on the emitted entry chunk.
