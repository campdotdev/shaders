...
// @camp-dev/shaders/gamut — display-gamut detection, SSR-safe.
//
...
// does. The directive on line 1 marks the client boundary for consumers that
// read this file as source.
export { useDisplayGamut } from './react/hooks/use-display-gamut/use-display-gamut.js';
export type { GamutPreference } from './react/hooks/use-display-gamut/use-display-gamut.js';
