// Shared color plumbing for every Tier 1 component: decode color strings
...
// Every component imports this file, so it stays dependency-light (engine +
// TSL only) and never reaches the React binding.
import { vec3 } from 'three/tsl';

import { type ColorRampStop, parseColorString } from '../../engine.js';
