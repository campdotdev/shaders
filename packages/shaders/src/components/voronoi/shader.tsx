...
export interface VoronoiShaderProps {
   ...
   * `drift` and `speed` govern movement. Accepts a static value or an
   * animation signal.
   */
...
export function VoronoiShader({
  ...
  // ---------------------------------------------
  // Cells must stay roughly square on any canvas shape. useAspectUniform
  // keeps the ratio current across resizes.
