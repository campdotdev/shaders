...
// repaint lands. It uses the default `dotSize` of 3, which reads the
// atlas at mip level 4 on a 2x display and at the shader's level-5 clamp
// on a 1x display, where a missing gutter would show as a sliver of a
