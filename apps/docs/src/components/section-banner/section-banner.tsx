 ...
 * faint lime wash under a still grid of small x marks (banner-shader.tsx).
 * The components layout renders it with "Components", so the index and
 * every component page share it.
 */
