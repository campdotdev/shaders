 ...
 * not, because it keeps its size for the reason below. The box hangs off the
 * band's bottom edge rather than its top (.scene in section-banner.module.css),
 * so the 32px it has over is spent above the nav row, off the top of the
 * viewport, and never below the band.
 *
