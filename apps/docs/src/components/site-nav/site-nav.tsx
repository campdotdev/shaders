 ...
 * over the blurred page, with the logo and a Close button on the same row
 * the header draws them, Docs and Examples right-aligned in large type
 * under it, and the GitHub link at the bottom. The header renders it
 * beside its link row and CSS shows one or the other at 40rem of the site
 * container. A Base UI Dialog rather than a Drawer: the overlay covers the
 * viewport and fades in, nothing slides from an edge or is swiped away,
