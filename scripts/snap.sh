...
for dir in apps/docs apps/docs-tests apps/editor packages/shaders packages/shaders-react \
           packages/shaders-cli registry tooling/eslint-config tooling/tsconfig; do
